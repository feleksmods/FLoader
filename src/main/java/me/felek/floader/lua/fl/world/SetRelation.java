...
public class SetRelation extends ThreeArgFunction {
    @Override
    public LuaValue call(LuaValue arg, LuaValue luaValue1, LuaValue luaValue2) {
        ...
        CFG.core.setCivRelationOfCivB(arg.checkint(), luaValue1.checkint(), luaValue2.checkint());
        return NIL;
    }
}
